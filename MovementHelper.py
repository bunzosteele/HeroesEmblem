...
class MovementHelper():
    ...
    def draw_movement_shadow(x, y, game_state, screen):
        options = MovementHelper.get_movement_options(x, y, game_state.units, game_state.get_selected_unit(), game_state.battlefield, game_state.get_selected_unit().Movement)
